...
public class My4thScoringIterator extends ScoringFunctionIterator implements DeltaScoringIterator {
  ...
  public My4thScoringIterator(NodeParameters np, LengthsIterator ls, CountIterator it)
          throws IOException {
    super(np, ls, it);
  ...
  private double score(double count, double length) {
    ...
    double dummy = count / (1 - b + (b * length / avgDocLength));
    return idf * (((k+1) * (dummy + 0.5)) / (k + (dummy + 0.5)));
  }
