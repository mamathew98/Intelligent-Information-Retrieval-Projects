...
public class My1stScoringIterator extends ScoringFunctionIterator implements DeltaScoringIterator {
  ...
  public My1stScoringIterator(NodeParameters np, LengthsIterator ls, CountIterator it)
          throws IOException {
    super(np, ls, it);
