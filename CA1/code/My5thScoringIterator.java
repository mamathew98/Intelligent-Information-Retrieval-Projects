...
public class My5thScoringIterator extends ScoringFunctionIterator implements DeltaScoringIterator {
  ...
  public My5thScoringIterator(NodeParameters np, LengthsIterator ls, CountIterator it)
          throws IOException {
    super(np, ls, it);
  ...
  private double score(double count, double length) {
    ...
    return idf * ((numerator / denominator) + 0.7);
  }
